...
public class Comparable_1 implements Comparable<Comparable_1> {
    private String brand;
    private int id;

    public Comparable_1(String brand, int id) {
        this.brand = brand;
        this.id = id;
    }

    // Let's compare first by brand and then by id
    public int compareTo(Comparable_1 other) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Comparable_1)) return false;
       String s = ((Comparable_1)other).brand;
        return this.brand.equals(s)
            && this.id == ((Comparable_1)other).id;
    }

    public static void main(String[] args) {
        Comparable_1 c1 = new Comparable_1("Lenovo", 1);
        Comparable_1 c2 = new Comparable_1("Apple", 2);
        Comparable_1 c3 = new Comparable_1("Dell", 3);
        Comparable_1 c4 = new Comparable_1("Lenovo", 1);
        ...
        List<Comparable_1> list = Arrays.asList(c1, c2, c3, c4);
