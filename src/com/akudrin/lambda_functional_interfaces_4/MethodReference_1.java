...
// Using an anonymous class
        findNumbers(list, new BiPredicate<Integer, Integer>() {
            public boolean test(Integer i1, Integer i2) {
                return MethodReference_1.isMoreThanFifty(i1, i2);
            }
        });
...
// Using a lambda expression
        findNumbers(list, (i1, i2) -> MethodReference_1.isMoreThanFifty(i1, i2));

// Using a method reference
        findNumbers(list, MethodReference_1::isMoreThanFifty);
    }
